...
_STREAMINGRECOGNIZERESPONSE_SPEECHEVENTTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NO_INPUT_TIMEOUT', index=2, number=4,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_RECOGNITIONCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='config_fields', full_name='google.cloud.speech.v1.RecognitionConfig.config_fields', index=7,
...
_STREAMINGRECOGNITIONRESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='lattice', full_name='google.cloud.speech.v1.StreamingRecognitionResult.lattice', index=3,
