...
void Health::Stub::experimental_async::Check(::grpc::ClientContext* context, const ::grpc::health::v1::HealthCheckRequest* request, ::grpc::health::v1::HealthCheckResponse* response, std::function<void(::grpc::Status)> f) {
...
void Health::Stub::experimental_async::Check(::grpc::ClientContext* context, const ::grpc::health::v1::HealthCheckRequest* request, ::grpc::health::v1::HealthCheckResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
void Health::Stub::experimental_async::Watch(::grpc::ClientContext* context, const ::grpc::health::v1::HealthCheckRequest* request, ::grpc::experimental::ClientReadReactor< ::grpc::health::v1::HealthCheckResponse>* reactor) {
